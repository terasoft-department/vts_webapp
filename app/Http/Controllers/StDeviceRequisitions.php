...
class StDeviceRequisitions extends Controller
{
    ...
    public function index()
    {
        ...
        return view('sdevice_requisitions.index', compact('requisitions','users','device'));
    }
    ...
    public function create()
    {
        ...
        return view('sdevice_requisitions.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('dispatched_historyv2.index')->with('success', 'Requisition created successfully.');
    }



    public function dispatchedDeviceHistory2()
    {
...
public function update(Request $request, $id)
{
    ...
    public function edit($id)
    {
        ...
        // $requisition = DeviceRequisition::findOrFail($id);
        return view('sdevice_requisitions.edit', compact('requisition'));
    }
