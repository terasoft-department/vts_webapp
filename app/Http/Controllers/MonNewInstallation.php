...
class MonNewInstallation extends Controller
{
    ...
    $installations = NewInstallation::when($query, function ($queryBuilder) use ($query) {
        ...
        return view('new_installations2.index', compact('installations','users'));
    }
    ...
    public function create()
    {
        ...
        $users = User::all();
        return view('new_installations2.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('new_installations2.index')->with('success', 'Installation created successfully');
    }
    ...
    public function show($id)
{
    ...
    return view('new_installations2.show', compact('installation'));
}
    ...
    public function edit(NewInstallation $newInstallation)
    {
        // Fetch all users for the user_id field
        $users = User::all();
        return view('new_installations2.edit', compact('newInstallation', 'users'));
    }
    ...
    public function update(Request $request, NewInstallation $newInstallation)
    {
        ...
        return redirect()->route('new_installations2.index')->with('success', 'Installation updated successfully');
    }
    ...
    public function destroy(NewInstallation $newInstallation)
    {
        ...
        return redirect()->route('new_installations2.index')->with('success', 'Installation deleted successfully');
    }
}
