...
class AdminTrackDebtsController extends Controller
{
    ...
    {
        return view('Admintdebts.create'); // Create a view for the invoice creation form
    }
    ...
    {
        $invoice = Invoice::findOrFail($id);
        return view('Admintdebts.show', compact('invoice')); // Create a view to display the invoice details
    }
    ...
    {
        $invoice = Invoice::findOrFail($id);
        return view('Admintdebts.edit', compact('invoice')); // Create a view for editing the invoice
    }
