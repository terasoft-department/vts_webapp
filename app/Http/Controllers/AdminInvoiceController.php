    ...
    public function index(Request $request)
{
    ...
    return view('admininvoice.index', compact('invoicePayments', 'customers'));
}
...
public function create()
{
    ...
    return view('admininvoice.create', compact('nextInvoiceNumberFormatted', 'customers'));
}
public function show($id)
{
    ...
    public function edit($id)
    {
        ...
        // return view('admininvoice.edit', compact('invoicePayment', 'customers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admininvoice.index')->with('success', 'Invoice Payment created successfully.');
    }
