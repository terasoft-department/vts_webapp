...
class MjobcardsController extends Controller
{
 ...
 public function store(Request $request)
 {
     ...
     return redirect()->route('jobcards2.index')->with('success', 'Job Card added successfully!');
 }
 ...
 public function edit($id)
 {
     ...
     return view('jobcards2.edit', compact('jobCard'));
 }
 ...
 public function destroy($id)
 {
     ...
     // Redirect back with a success message
     return redirect()->route('jobcards2.index')->with('success', 'Job Card deleted successfully!');
 }
}
