...
class AdminInvoice2Controller extends Controller
{
    ...
    public function index(Request $request)
{
    ...
    return view('admininvoice2.index', compact('invoicePayments', 'customers'));
}
...
public function create()
{
    ...
    return view('admininvoice2.create', compact('nextInvoiceNumberFormatted', 'customers'));
}
public function show($id)
{
    ...
    public function edit($id)
    {
        ...
        // return view('admininvoice2.edit', compact('invoicePayment', 'customers'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admininvoice2.index')->with('success', 'Invoice Payment created successfully.');
    }
