...
class SReturnDeviceController extends Controller
{
    public function index()
    {
        ...
        return view('Sreturn_device.index', compact('returnDevices'));
    }
    ...
    public function show($return_id)
    {
        ...
        return view('Sreturn_device.show', compact('returnDevice'));
    }
    ...
    public function updateStatus(Request $request, $return_id)
    {
        ...
        return redirect()->route('Sreturn_device.index')->with('success', 'Status updated successfully.');
    }
}
