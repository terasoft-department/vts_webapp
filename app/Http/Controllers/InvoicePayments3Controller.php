...
class InvoicePayments3Controller extends Controller
{
    ...
    public function index(Request $request)
{
    ...
    return view('invoice_payments3.index', compact('invoicePayments', 'customers'));
}
...
public function create()
{
    ...
    return view('invoice_payments3.create', compact('nextInvoiceNumberFormatted', 'customers'));
}
public function show($id)
{
    ...
    public function edit($id)
    {
        ...
        // return view('invoice_payments3.edit', compact('invoicePayment', 'customers'));
    }
    ...
    public function store(Request $request)
    {
       ...
       'num_cars' => 'required|integer|min:1',
        ...
        return redirect()->route('invoice_payments3.index')->with('success', 'Invoice Payment created successfully.');
    }
