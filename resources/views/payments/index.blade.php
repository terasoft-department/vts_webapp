...
<div class="container mt-5">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('invoice_payments.index') }}" class="mb-2">
                <div class="row">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="button" class="btn btn-secondary" onclick="window.location.href='{{ route('invoice_payments.index') }}'">Cancel</button>
                </div>
            </form>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr id="invoice-row-{{ $invoice->id }}">
                    ...
                    <td>
                        ...
                        <button class="btn btn-info btn-sm" onclick="showInvoice({{ $invoice->id }})"><i class="fas fa-eye"></i></button>
                        <button class="btn btn-danger btn-sm" onclick="deleteInvoice({{ $invoice->id }})"><i class="bi bi-trash"></i></button>
                    </td>
                </tr>
                @endforeach
            </tbody>
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="periods" id="periods" class="form-control" required>
                        </div>
                    </div>
