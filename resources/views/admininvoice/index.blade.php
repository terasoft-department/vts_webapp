    ...
    <main id="main" class="main">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="GET" action="{{ route('admininvoice2.index') }}" class="mb-2">
                    <div class="row">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="button" class="btn btn-secondary" onclick="window.location.href='{{ route('admininvoice2.index') }}'">Cancel</button>
                    </div>
                </form>
            </div>
         </div>
