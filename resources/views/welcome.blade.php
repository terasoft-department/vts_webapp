...
<head>
  ...
  <link href="assets/img/about.png" rel="icon">
   <link href="assets/img/about.png" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      <a href="index.html" class="logo me-auto"><img src="./images/logo.png" alt="" class="img-fluid" style="height:8rem;width:6rem"></a>
