            ...
            fetch(`/api/get-customer-details?plate_number=${plateNumber}`)
                ...
                .then(data => {
                    if (data) {
                        ...
                        document.getElementById('customer_debt').value = data.customer_debt; // Add this field if needed
                    } else {
                        document.getElementById('customer_name').value = '';
                        document.getElementById('customer_phone').value = '';
                        document.getElementById('customer_debt').value = ''; // Clear debt if no customer found
                    }
                })
