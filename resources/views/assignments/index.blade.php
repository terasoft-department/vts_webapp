            ...
            <div class="row mb-3">
                <div class="col-md-8">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="Search assignments..." aria-label="Search assignments">
                        <button class="btn btn-primary" type="button" style="background-color:#4177fd;">
