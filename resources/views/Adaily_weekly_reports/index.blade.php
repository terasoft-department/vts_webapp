...
<main id="main" class="main">
    <div class="text-left">
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                <form method="GET" action="{{ route('Adaily_weekly_reports.index') }}" class="form-inline d-flex flex-wrap justify-content-between align-items-center">
                    <!-- Start Date -->
                    ...
                    <!-- Clear Button -->
                    <div class="form-group mb-2 mx-2">
                        <a href="{{ route('Adaily_weekly_reports.index') }}" class="btn btn-outline-secondary d-flex align-items-center px-4 py-2">
